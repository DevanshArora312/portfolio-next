...
import { setRotate, setY, setlastX,setSpeed } from "../redux/slices/islandRotate";
...
const Island =  ({
  ...
  ...props
    ...
    const rotate = useSelector((state) => state.islandRotate.rotation);
    const islandRef = useRef();

    const { gl, viewport } = useThree();
    const { nodes, materials } = useGLTF("/island.glb");
    
    const lastX = useSelector(state => state.islandRotate.lastX);
    ...
    const handlePointerMove = (event) => {
        ...
        islandRef.current.rotation.y = rotate[1];
    ...
    useFrame(() => {
        ...
        dispatch(setY(islandRef.current.rotation.y));
        } else {
